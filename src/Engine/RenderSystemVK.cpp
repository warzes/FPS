...
//=============================================================================
RaytracingShaderHandle* RenderSystem::CreateRaytracingShader(const std::string& raygen_code, const std::vector<std::string>& miss_code, const std::string& closesthit_code, const std::vector<std::string>& defines)
{
...
//=============================================================================
void RenderSystem::DestroyRaytracingShader(RaytracingShaderHandle* handle)
{
...
//=============================================================================
BottomLevelAccelerationStructureHandle* RenderSystem::CreateBottomLevelAccelerationStructure(const void* vertex_memory,
...
//=============================================================================
void RenderSystem::DestroyBottomLevelAccelerationStructure(BottomLevelAccelerationStructureHandle* handle)
{
...
//=============================================================================
TopLevelAccelerationStructureHandle* RenderSystem::CreateTopLevelAccelerationStructure(
...
//=============================================================================
void RenderSystem::DestroyTopLevelAccelerationStructure(TopLevelAccelerationStructureHandle* handle)
{
...
//=============================================================================
StorageBufferHandle* RenderSystem::CreateStorageBuffer(size_t size)
{
...
//=============================================================================
void RenderSystem::DestroyStorageBuffer(StorageBufferHandle* handle)
{
...
//=============================================================================
void RenderSystem::WriteStorageBufferMemory(StorageBufferHandle* handle, const void* memory, size_t size)
{
	auto buffer = (StorageBufferVK*)handle;
	buffer->Write(memory, size);
}
